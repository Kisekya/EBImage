...
/* Internal functions */
	...
	this.setFrame = function(frame) {
		...
		viewer.updateStatusField("Frame", currentFrame+'/'+numberOfFrames);
	        Shiny.setInputValue("the_namespace_id-currentFrame", currentFrame);
...
/* Mouse and keyboard actions */
	...
	this.grabImage =  function(event) {
		...
		Shiny.setInputValue("the_namespace_id-pixelPosition", viewer.getPixelPosition(event));
		Shiny.setInputValue("the_namespace_id-notfromr", Math.random());
...
/* Set image */
	...
	Shiny.setInputValue("the_namespace_id-imgWidth", originalWidth);
	Shiny.setInputValue("the_namespace_id-imgHeight", originalHeight);
